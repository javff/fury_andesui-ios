...
class TooltipHighlightFactory: TooltipAbstractFactory {
    ...
    func buildWithoutAction(using showCase: TooltipDataShowCase) -> AndesTooltip {
        return AndesTooltip(highlightStyle: showCase.content, title: showCase.title, isDismissable: showCase.isDissmisable)
    }
    ...
    func buildWithPrimaryActionOnly(using showCase: TooltipDataShowCase) -> AndesTooltip? {
        ...
        if primaryActionStyle == .link {
            return AndesTooltip(highlightStyle: showCase.content,
